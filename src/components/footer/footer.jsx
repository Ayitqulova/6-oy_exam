        ...
        <section className="bg-[#ffe6d2]" >
           ...
           <div className="flex gap-5 items-center">
            ...
            <div className="grid grid-cols-4 gap-5 items-center px-[50px] ">
                <img className="size-[16px] " src="public/images/Negative.png" alt="" />
                <img className="size-[16px] " src="public/images/Vector.png" alt="" />
                <img className="size-[16px] " src="public/images/Insta.png" alt="" />
                <img className="size-[16px] " src="public/images/Link.png" alt="" />
